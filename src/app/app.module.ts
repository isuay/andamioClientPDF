import { GeneratePDFUnroutedComponent } from './component/shared/unrouted/generatePDF-unrouted/generatePDF-unrouted.component';
import { DeveloperDetailedAdminUnroutedComponent } from './component/application/developer/unrouted/admin/developer-detailed-admin-routed/developer-detailed-admin-unrouted.component';
...
import { ResolutionAllAdminRoutedComponent } from './component/application/resolution/routed/admin/resolution-all-admin-routed/resolution-all-admin-routed.component';
...
@NgModule({
  declarations: [
    ...
    DeveloperDetailedAdminUnroutedComponent,
