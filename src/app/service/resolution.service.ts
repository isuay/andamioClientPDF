...
export class ResolutionService {
  ...
  getAll(): Observable<ResolutionResponse> {
    return this.oHttp.get<ResolutionResponse>(this.url + "/all");
  }
  ...
  getPage(page: number, size: number, filter: string): Observable<ResolutionResponse> {
    let params = new HttpParams()
      ...
      .set("page", page)
      .set("size", size);
    return this.oHttp.get<ResolutionResponse>(this.url, { params: params });
  }
